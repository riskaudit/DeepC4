function [Q, data] = preprocessCensus(  census_fpath, ...
                                macro_taxonomy_table_fpath, ...
                                height_table_fpath, ...
                                dwelling_table_fpath)

    data = readtable(census_fpath, 'VariableNamingRule', 'preserve');
    nDwellings_rur = data.nDwellings_rur;
    nDwellings_urb = data.nDwellings_urb;
    
    T = readtable(macro_taxonomy_table_fpath);
    height_table = readtable(height_table_fpath);
    dwelling_table = readtable(dwelling_table_fpath);
