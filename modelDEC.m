...
% save("output/20240917_JointDC_AddressedRandomCentroidInitialization/outputTrainedModels.mat",... ...
...
% save("output/20240918_JointDC_GaussianMix/outputTrainedModels.mat",... ...
%     "netE_history","netD_history",...
%     "xTPpropR_history","xTPpropH_history","xTPpropW_history",...
%     "BatchTPpropR_history","BatchTPpropH_history","BatchTPpropW_history",...
%     "ReconstructionLoss_history","PredictionLoss_history")
% save("output/20240918_JointDC_SpectralClustering/outputTrainedModels.mat",... ...
%     "netE_history","netD_history",...
%     "xTPpropR_history","xTPpropH_history","xTPpropW_history",...
%     "BatchTPpropR_history","BatchTPpropH_history","BatchTPpropW_history",...
%     "ReconstructionLoss_history","PredictionLoss_history")
% save("output/20240918_JointDC_TraditionalKMeans/outputTrainedModels.mat",... ...
%     "netE_history","netD_history",...
%     "xTPpropR_history","xTPpropH_history","xTPpropW_history",...
%     "BatchTPpropR_history","BatchTPpropH_history","BatchTPpropW_history",...
%     "ReconstructionLoss_history","PredictionLoss_history")
load("output/20240917_JointDC_AddressedRandomCentroidInitialization/outputTrainedModels.mat",... ...
    "netE_history","netD_history",...
    "xTPpropR_history","xTPpropH_history","xTPpropW_history",...
    "BatchTPpropR_history","BatchTPpropH_history","BatchTPpropW_history",...
    "ReconstructionLoss_history","PredictionLoss_history")
% load("output/20240918_JointDC_GaussianMix/outputTrainedModels.mat",... ...
%     "netE_history","netD_history",...
%     "xTPpropR_history","xTPpropH_history","xTPpropW_history",...
%     "BatchTPpropR_history","BatchTPpropH_history","BatchTPpropW_history",...
%     "ReconstructionLoss_history","PredictionLoss_history")
% load("output/20240918_JointDC_SpectralClustering/outputTrainedModels.mat",... ...
%     "netE_history","netD_history",...
%     "xTPpropR_history","xTPpropH_history","xTPpropW_history",...
%     "BatchTPpropR_history","BatchTPpropH_history","BatchTPpropW_history",...
%     "ReconstructionLoss_history","PredictionLoss_history")
% load("output/20240918_JointDC_TraditionalKMeans/outputTrainedModels.mat",... ...
%     "netE_history","netD_history",...
%     "xTPpropR_history","xTPpropH_history","xTPpropW_history",...
%     "BatchTPpropR_history","BatchTPpropH_history","BatchTPpropW_history",...
%     "ReconstructionLoss_history","PredictionLoss_history")
...
target_epochs = find(sum(ReconstructionLoss_history<=5,2)>0 ...
                & sum(PredictionLoss_history<=1,2)>0);
target_epochs = target_epochs(target_epochs <= 54);
    ...
    if rID ~= 111 && ...
       string(label2rasterID.NAME_3(find(label2rasterID.RASTER_ID1 == rID))) ~= "Lac Kivu" % Rudashya Fix and Lake Kivu Fix
        ...
        while err > 0.01 | failed == 1
            try
                [labelsR,centroidsR] = constrainedKMeans_DEC(Z(1:2,:), sum(tauR > 1e-5), tauR(tauR ~= 0), 50);
                failed = 0;
            catch MyErr
                failed = 1;
            end
        ...
        while err > 0.01 | failed == 1
            try
                [labelsW,centroidsW] = constrainedKMeans_DEC(Z(5:6,:), sum(tauW > 1e-5), tauW(tauW ~= 0), 50);
                failed = 0;
            catch MyErr
                failed = 1;
            end
        ...
        for j = 1:numel(nonzero_idx_tauW) % per wall category
            ...
            while err > 0.01 | failed == 1
                try
                    [labelsM,centroidsM] = constrainedKMeans_DEC(Z(5:6,wall_assignment == string(uniq_WallClass(nonzero_idx_tauW(j),1))),...
        ...
        for j = 1:numel(uniq_MacroTaxonomy_from_assignment) % per macro taxo category
            ...
            while err > 0.01 | failed == 1
                try
                    [labelsH,centroidsH] = constrainedKMeans_DEC(Z(3:4, macro_taxonomy_assignment==string(uniq_MacroTaxonomy_from_assignment(j,1)) ),...
...
%% Export
geotiffwrite("output/20240919_JointDC_OutputMaps/y_height.tif",(y_height),maskR)
geotiffwrite("output/20240919_JointDC_OutputMaps/y_roof.tif",(y_roof),maskR)
geotiffwrite("output/20240919_JointDC_OutputMaps/y_macrotaxo.tif",(y_macrotaxo),maskR)
geotiffwrite("output/20240919_JointDC_OutputMaps/y_wall.tif",(y_wall),maskR)