function [loss2,loss3,xTPprop,xTPpropH,xTPpropW, ...
    ...
    nsubtempH = histcounts(subtempH,1:8)';
                ...
                if nsubtemp(i) ~= 0
                    ...
                    if ~isempty(common_index)
                        ...
                        sum(...
                            ...
                            sum(distance_error_array(:,:,common_index),3))./size(subZ,2);
                ...
                if ~isempty(common_index2)
                    loss3_basedOnDistanceErrorH = loss3_basedOnDistanceErrorH + ...
                        sum(...
                            ...
                            sum(distance_error_arrayH(:,:,common_index2),3))./size(subZ,2);
                ...
                if ~isempty(common_index2)
                    loss3_basedOnDistanceErrorW = loss3_basedOnDistanceErrorW + ...
                        sum(...
                            ...
                            sum(distance_error_arrayW(:,:,common_index2),3))./size(subZ,2);
    ...
    xTPprop = [ ...
       ...
       ].*sum(nsubtemp)./(nsubtemp.*length(nsubtemp));
    ...
    xTPpropH = [ ...
       ...
       sum( (subtempH==5) .* (sub_y_height==4|sub_y_height==5) )./sum(subtempH==5) ; ...
       sum( (subtempH==6) .* (sub_y_height==5|sub_y_height==6) )./sum(subtempH==6) ; ...
       sum( (subtempH==7) .* (sub_y_height==6) )./sum(subtempH==7) ...
       ].*sum(nsubtempH)./(nsubtempH.*length(nsubtempH));
