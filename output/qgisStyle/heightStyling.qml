...
<qgis version="3.28.13-Firenze" maxScale="0" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" minScale="1e+08">
  ...
  <pipe>
    ...
    <rasterrenderer type="paletted" opacity="1" nodataColor="" band="1" alphaBand="-1">
      ...
      <colorPalette>
        <paletteEntry alpha="255" value="1" color="#2b83ba" label="H:1"/>
        <paletteEntry alpha="255" value="2" color="#91cba8" label="H:2"/>
        <paletteEntry alpha="255" value="3" color="#ddf1b4" label="H:3"/>
        <paletteEntry alpha="255" value="4" color="#fedf99" label="HBET:3-6"/>
        <paletteEntry alpha="255" value="5" color="#f59053" label="HBET:4-7"/>
        <paletteEntry alpha="255" value="6" color="#d7191c" label="HBET:8+"/>
      </colorPalette>
