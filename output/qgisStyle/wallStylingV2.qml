...
<qgis version="3.28.13-Firenze" minScale="1e+08" styleCategories="AllStyleCategories" maxScale="0" hasScaleBasedVisibilityFlag="0">
  ...
  <pipe>
    ...
    <rasterrenderer alphaBand="-1" band="1" type="paletted" nodataColor="" opacity="1">
      ...
      <colorPalette>
        <paletteEntry label="Wood w/ mud" alpha="255" value="1" color="#afd132"/>
        <paletteEntry label="Sun-dried bricks" alpha="255" value="2" color="#e79260"/>
        <paletteEntry label="All non-durable materials" alpha="255" value="3" color="#b04be7"/>
        <paletteEntry label="Cement blocks" alpha="255" value="4" color="#ee8aba"/>
        <paletteEntry label="Concrete" alpha="255" value="5" color="#e4bc1e"/>
        <paletteEntry label="Stones" alpha="255" value="6" color="#ca3fbe"/>
        <paletteEntry label="Timber" alpha="255" value="7" color="#3555d5"/>
        <paletteEntry label="Burnt bricks" alpha="255" value="8" color="#b1ee90"/>
      </colorPalette>
