...
<qgis version="3.28.13-Firenze" maxScale="0" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" minScale="1e+08">
  ...
  <pipe>
    ...
    <rasterrenderer type="paletted" opacity="1" nodataColor="" band="1" alphaBand="-1">
      ...
      <colorPalette>
        <paletteEntry alpha="255" value="1" color="#afd132" label="Wood w/ mud &amp; cement"/>
        <paletteEntry alpha="255" value="2" color="#7a57ec" label="Wood w/ mud &amp; no cement"/>
        <paletteEntry alpha="255" value="3" color="#e79260" label="Sun-dried bricks w/ cement"/>
        <paletteEntry alpha="255" value="4" color="#58d3cb" label="Sun-dried bricks w/ no cement"/>
        <paletteEntry alpha="255" value="5" color="#b04be7" label="All non-durable materials"/>
        <paletteEntry alpha="255" value="6" color="#ee8aba" label="Cement blocks"/>
        <paletteEntry alpha="255" value="7" color="#e4bc1e" label="Concrete"/>
        <paletteEntry alpha="255" value="8" color="#ca3fbe" label="Stones w/ cement"/>
        <paletteEntry alpha="255" value="9" color="#20d178" label="Stones w/ no cement"/>
        <paletteEntry alpha="255" value="10" color="#3555d5" label="Timber"/>
        <paletteEntry alpha="255" value="11" color="#b1ee90" label="Burnt bricks w/ cement"/>
        <paletteEntry alpha="255" value="12" color="#6ca9ce" label="Burnt bricks w/ no cement"/>
        <paletteEntry alpha="255" value="13" color="#e94f59" label="Other types"/>
        <paletteEntry alpha="255" value="14" color="#2fde3e" label="Not stated"/>
      </colorPalette>
